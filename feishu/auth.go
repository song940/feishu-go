...
func (c *Client) GetTenantAccessToken() (out AccessTokenResponse, err error) {
...
func (c *Client) GetTenantAccessTokenInternal() (out AccessTokenResponse, err error) {
...
func (c *Client) GetAppAccessToken() (out AccessTokenResponse, err error) {
...
func (c *Client) GetAppAccessTokenInternal() (out AccessTokenResponse, err error) {
...
func (c *Client) RefreshUserAccessToken(refreshToken string, grantType string) {
...
func (c *Client) ResendAppTicket() (out FeishuResponseBase, err error) {
